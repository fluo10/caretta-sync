...
use crate::{mcp::{Api, model::{self, DevicePingRequest, DevicePingResponse}}, types::{AppDatabase, Database}};
...
impl Api for ServiceContext {
    ...
    async fn device_ping(&self, params: DevicePingRequest) -> Result<DevicePingResponse, ErrorData> {
