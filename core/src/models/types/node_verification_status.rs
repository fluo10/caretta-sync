...
use crate::proto::{ProtoDeserializeError, api::device_verification::list_request::Status};
...
impl TryFrom<Status> for NodeVerificationStatus {
    ...
    fn try_from(value: Status) -> Result<Self, Self::Error> {
        match value {
            ...
            Status::Unspecified => Err(ProtoDeserializeError::EnumUnspecified(
                "caretta_sync.api.device_verification.ListRequest.Status",
            )),
